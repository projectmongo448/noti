...
})(window, function(__WEBPACK_EXTERNAL_MODULE__4__, __WEBPACK_EXTERNAL_MODULE__9__, __WEBPACK_EXTERNAL_MODULE__25__) {
...
var dotnetify_1 = __webpack_require__(16);
var dotnetify_vm_1 = __webpack_require__(5);
...
var jQueryDeferred = __webpack_require__(13);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(0), __webpack_require__(14)(module)))
...
function enableSsr() {
    ...
    dotnetify_react_1.default.react.router.ssr = function (iCallbackFn, iRequestUrlPath, iInitialState, iTimeout) {
        ...
        var callback = function () {
            return iCallbackFn(null, "<!DOCTYPE html>" + document.documentElement.outerHTML);
        };
...
var jQuery = module.exports = __webpack_require__(11),
...
var signalRNetCore = __webpack_require__(9);
var $ = jQueryShim;
var _window = window || global || {};
...
var dotnetify_hub_1 = __webpack_require__(15);
var dotnetify_hub_local_1 = __webpack_require__(8);
var dotnetify_hub_webapi_1 = __webpack_require__(7);
...
var dotnetify_react_1 = __webpack_require__(2);
var dotnetify_react_router_ssr_1 = __webpack_require__(6);
...
var dotnetify_vm_router_1 = __webpack_require__(24);
var $ = __webpack_require__(3);
var utils_1 = __webpack_require__(1);
var _window = window || global || {};
var DotnetifyReactVMRouter = (function (_super) {
    ...
    DotnetifyReactVMRouter.prototype.loadView = function (iTargetSelector, iViewUrl, iJsModuleUrl, iVmArg, iCallbackFn) {
        ...
        if (this.hasRoutingState) {
            if (this.RoutingState === null) {
                console.error("router> the RoutingState prop of '" +
                    vm.$vmId +
                    "' was not initialized.");
                return;
            }
            ...
            root =
                root != null
                    ? "/" + utils_1.default.trim(this.RoutingState.Root) + "/" + utils_1.default.trim(root)
    ...
    DotnetifyReactVMRouter.prototype.loadReactView = function (iTargetSelector, iComponent, iJsModuleUrl, iReactProps, iCallbackFn) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var mountViewFunc = function () {
                ...
                _this.unmountView(iTargetSelector);
                try {
                    var args = [reactElement, document.querySelector(iTargetSelector)];
                    if (vm.$dotnetify["ssrEnabled"] === true)
                        ReactDOM.hydrate.apply(ReactDOM, args);
                    else
                        ReactDOM.render.apply(ReactDOM, args);
                }
                catch (e) {
                    console.error(e);
                }
...
var RouteLink_1 = __webpack_require__(19);
var RouteTarget_1 = __webpack_require__(18);
var useConnect_1 = __webpack_require__(17);
